...
export default function Landing() {
  ...
  return (
    <div className="quantum-bg">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-14 sm:px-6 sm:pt-20">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="animate-fade-up">
            <h1 className="text-4xl font-extrabold leading-[1.08] tracking-tight text-ink sm:text-5xl xl:text-6xl">
              Quantum Computing,{" "}
      ...
      {/* ── Why it's hard ────────────────────────────────────────────────── */}
      <section className="border-t border-line bg-card2/40 py-16">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="flex h-11 items-center gap-1.5 rounded-xl border border-line-strong bg-card2 px-3 font-mono text-xs font-bold text-ink-2">
                  M
                </span>
              </div>
              <div className="mt-6">
            ...
            <Card className="overflow-hidden">
              <div className="border-b border-line bg-page/60 px-4 py-2.5 font-mono text-xs text-ink-3">
                bell-state.qx — a working circuit
              </div>
              <div className="p-6">
                <svg viewBox="0 0 280 110" className="w-full">
                  <line x1="14" y1="30" x2="266" y2="30" stroke="var(--viz-wire)" strokeWidth="1.5" />
                  <line x1="14" y1="80" x2="266" y2="80" stroke="var(--viz-wire)" strokeWidth="1.5" />
                  <text x="11" y="34" fill="var(--viz-gate-text)" fontSize="11" fontFamily="monospace" textAnchor="end">q0</text>
                  <text x="11" y="84" fill="var(--viz-measure-text)" fontSize="11" fontFamily="monospace" textAnchor="end">q1</text>
                  <rect x="52" y="18" width="28" height="24" rx="4" fill="var(--viz-gate-bg)" stroke="var(--qx-violet-raw, #8b5cf6)" />
                  <text x="66" y="35" fill="var(--viz-gate-text)" fontSize="14" fontFamily="monospace" textAnchor="middle" fontWeight="700">H</text>
                  <circle cx="122" cy="30" r="4.5" fill="var(--viz-dot)" />
                  <line x1="122" y1="30" x2="122" y2="80" stroke="var(--viz-wire-strong)" strokeWidth="1.5" />
                  <circle cx="122" cy="80" r="9" fill="var(--viz-measure-bg)" stroke="var(--viz-measure-ring)" strokeWidth="1.5" />
                  <circle cx="122" cy="80" r="3" fill="var(--viz-measure-text)" />
                  <rect x="176" y="18" width="28" height="24" rx="4" fill="var(--viz-chip-bg)" stroke="var(--viz-chip-border)" />
                  <text x="190" y="35" fill="var(--viz-chip-text)" fontSize="11" fontFamily="monospace" textAnchor="middle">M</text>
                  <rect x="176" y="68" width="28" height="24" rx="4" fill="var(--viz-chip-bg)" stroke="var(--viz-chip-border)" />
                  <text x="190" y="85" fill="var(--viz-chip-text)" fontSize="11" fontFamily="monospace" textAnchor="middle">M</text>
                </svg>
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-line bg-page/60 p-3">
                    <p className="text-[11px] uppercase tracking-wider text-ink-3">Result distribution</p>
                    <p className="mt-1 font-mono text-sm text-ink">
                      <Ket value={0} n={2} /> <span className="text-qx-violet">50%</span> · <Ket value={3} n={2} /> <span className="text-qx-cyan">50%</span>
                    </p>
                  </div>
                  <div className="rounded-xl border border-line bg-page/60 p-3">
                    <p className="text-[11px] uppercase tracking-wider text-ink-3">What happened?</p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="overflow-hidden rounded-3xl border border-line bg-card2/60">
            <div className="grid items-center gap-8 p-8 sm:p-12 lg:grid-cols-[1.2fr_1fr]">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={s.l} className="rounded-2xl border border-line bg-page/60 p-5 text-center">
                    ...
                    <p className="mt-1 text-xs text-ink-3">{s.l}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            {FLOW.map((f, i) => (
              <React.Fragment key={f}>
                ...
                {i < FLOW.length - 1 && <ArrowRight className="h-4 w-4 text-ink-3" />}
              </React.Fragment>
            ))}
          </div>
          <p className="mx-auto mt-8 max-w-2xl text-center text-sm leading-relaxed text-ink-2">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              onClick={startDemo}
              className="inline-flex items-center gap-2 rounded-lg border border-line-strong bg-card px-6 py-3 text-base font-semibold text-ink transition hover:bg-card2"
            >
